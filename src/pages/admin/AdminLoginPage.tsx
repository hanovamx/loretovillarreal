      ...
      <Card className="relative w-full max-w-4xl overflow-hidden border border-slate-200 p-0 shadow-2xl">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <div className="relative hidden bg-slate-900 md:block">
            ...
            <div className="absolute inset-0 flex flex-col justify-between p-10 text-white">
              <div>
                ...
                <h1 className="mt-6 text-3xl font-heading tracking-[0.18em] text-white">STUDIO</h1>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-white/60">
                  Plataforma omnicanal
                </p>
                <p className="mt-4 text-sm uppercase tracking-[0.07em] text-white/70">
          ...
          <div className="flex flex-col justify-center px-6 py-10 md:px-10">
            <p className="text-xs uppercase tracking-[0.10em] text-slate-400">Acceso restringido</p>
            <h2 className="mt-6 text-2xl font-semibold uppercase tracking-[0.10em] text-slate-900">
              Dashboard de fotógrafa
            </h2>
            <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
              <label className="block">
                <span className="text-[10px] font-semibold uppercase tracking-[0.10em] text-slate-500">
                  Correo
                </span>
                <input
                  type="email"
                  className="mt-2 w-full rounded-full border border-slate-200 bg-white px-6 py-3 text-sm uppercase tracking-[0.07em] text-slate-700 outline-none transition focus:border-slate-900"
                  value={email}
            ...
            <div className="mt-10 space-y-3 text-sm text-slate-500">
              <p className="text-xs uppercase tracking-[0.06em] text-slate-400">
